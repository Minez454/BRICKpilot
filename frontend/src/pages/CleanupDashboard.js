...
import { AlertTriangle, MapPin, Calendar, Plus } from "lucide-react";
    ...
    <div className="min-h-screen yellow-brick-road">
      <div className="min-h-screen" style={{background: 'rgba(255, 255, 255, 0.85)'}}>
          ...
          <div className="container mx-auto">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-amber-100 text-lg">Welcome, {user?.full_name?.split(' ')[0]}!</p>
              </div>
        ...
        <div className="container mx-auto px-6 py-12">
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <Card className="border-4 border-amber-400 shadow-2xl hover:scale-105 transition-transform glitter">
              ...
              <CardContent className="pt-6">
                <p className="text-gray-700 mb-4">Alert individuals about upcoming cleanup operations with advance notice</p>
            ...
            <Card className="border-4 border-blue-400 shadow-2xl hover:scale-105 transition-transform glitter">
              ...
              <CardContent className="pt-6">
                <p className="text-gray-700 mb-4">View and manage upcoming cleanup operations</p>
          ...
          <Card className="border-4 border-rose-400 shadow-2xl glitter">
            <CardHeader className="bg-gradient-to-r from-rose-600 to-pink-600 text-white">
              <CardTitle className="text-2xl">⚠️ Important: Advance Notice Required</CardTitle>
            </CardHeader>
            <CardContent className="pt-8">
              <p className="text-lg text-gray-700 mb-4">
                When posting sweep schedules, always provide at least 14 days advance notice. Include:
              </p>
              <ul className="list-disc list-inside text-gray-700 space-y-2 text-lg">
                <li>Exact location and area description</li>
                <li>Date and time of cleanup</li>
                <li>Contact information for questions</li>
                <li>Resources available for relocation assistance</li>
              </ul>
            </CardContent>
          </Card>
        </div>
